...
3. Utilize the Context7 MCP Server to retrieve the latest supported version and recommended upgrade path for the libraries in use
4. Analyze vulnerabilities, conflicts, and optimization opportunities
5. Implement comprehensive dependency management solutions

IMPORTANT - When a major version upgrade is required, first bring the application and dependencies up-to-date on the latest minor version!  Only upgrade to a major version if it is detected that the application is on the latest minor version!
